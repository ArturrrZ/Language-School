...
// Photo imports commented out — photo feature disabled but data kept for reference
...
export const reviews: ReviewType[] = [
  { id: 1, name: 'John Doe', stars: '★★★★★', review: 'Great platform! Helped me improve my skills significantly.', face: null },
  { id: 2, name: 'Sarah Johnson', stars: '★★★★★', review: 'The interactive lessons and practical exercises made learning enjoyable and effective. I was able to apply what I learned immediately in my projects.', face: null },
  ...
  { id: 4, name: 'Emily Rodriguez', stars: '★★★★★', review: 'As a complete beginner, I found the step-by-step approach incredibly helpful. The instructors break down complex concepts into digestible pieces that are easy to understand.', face: null },
  ...
  { id: 6, name: 'Lisa Park', stars: '★★★★☆', review: 'I appreciate the flexibility this platform offers. Being able to learn at my own pace while having access to mentors when I need help has been invaluable for my growth.', face: null },
  { id: 7, name: 'James Wilson', stars: '★★★★★', review: 'This platform transformed my understanding of programming. The hands-on projects and code reviews from experienced developers helped me build confidence in my abilities.', face: null },
