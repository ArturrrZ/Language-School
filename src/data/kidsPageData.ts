...
export const kidsReviews: ReviewType[] = [
  { id: 1, name: 'John Doe', stars: '★★★★★', review: 'My daughter loves her English lessons! She looks forward to them every week and her confidence has grown so much.', face: null },
  { id: 2, name: 'Sarah Johnson', stars: '★★★★★', review: 'The teachers are wonderful with kids. My son actually asks to practice English at home now, which I never expected!', face: null },
  ...
  { id: 4, name: 'Emily Rodriguez', stars: '★★★★★', review: 'As a parent, I appreciate the progress reports and how patient the teachers are. My shy daughter has really come out of her shell.', face: null },
  ...
  { id: 6, name: 'Lisa Park', stars: '★★★★☆', review: 'The flexible schedule works perfectly for our busy family. The teachers make learning fun and my daughter is always excited for class.', face: null },
  { id: 7, name: 'James Wilson', stars: '★★★★★', review: 'Both of my kids are enrolled and they love it. The small group setting means they get plenty of attention and practice speaking.', face: null },
